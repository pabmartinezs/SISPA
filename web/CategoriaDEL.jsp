            ...
            <c:otherwise>
                ...
                <div class="container">
                    ...
                    <div class="text-center">
                        <div class="col-lg-12">
                            <h3 style="color: #084B8A"><b>Desactivar Categorias en el sistema</b></h3>
                                        ...
                                        <c:forEach items="${sessionScope.LSTCategoria}" var="LCategoria">
                                            <tr>
                                                <c:if test="${useCon.objusuario.idPerfil.idPerfil == 1}">
                                                    ...
                                                    <td>
                                                        <c:url value="./categoriaDELServlet" var="URLELI">
                                                            <c:param name="IDCAT" value="${LCategoria.idCategoria}"></c:param>
                                                        </c:url>
                                                        <button onclick="if(confirm('¿Seguro que desea desactivar la Categoria?')) window.location.href = '<c:out value="${URLELI}"></c:out>'">
