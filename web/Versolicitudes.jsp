            ...
            <c:otherwise>
                ...
                <div class="container">
                    ...
                    <div class="text-center">
                        <div class="col-lg-12">
                            <h3 style="color: #084B8A"><b>Estado de Solicitudes</b></h3>
                            <jsp:include flush="true" page="./pedidoCargarListaServlet"></jsp:include>
                            <jsp:useBean id="Lsolicitud" class="sispa.dto.solicitudFullDTO" scope="page"></jsp:useBean>
                            <c:if test="${sessionScope.SolicitudesUsuario != null}">
                                <table class="table table-hover" style="color: #084B8A">
                                    <thead>
                                        <tr>
                                            <th><div class="col-lg-3"></div>ID Solicittud</th>
                                            <th><div class="col-lg-3"></div>Fecha Pedido</th>
                                            <th><div class="col-lg-3"></div>Fecha Retiro</th>
                                            <th><div class="col-lg-3"></div>Estado Solicitud</th>
                                            <th><div class="col-lg-3"></div>Material</th>
                                            <th><div class="col-lg-3"></div>Observaciones Producto</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <c:forEach items="${sessionScope.SolicitudesUsuario}" var="Lsolicitud">
                                            <tr>
                                                <td><c:out value="${Lsolicitud.objsolicitudpedido.idPedido}"></c:out></td>
                                                <td><c:out value="${Lsolicitud.objsolicitudpedido.fechaPedido}"></c:out></td>
                                                <td><c:out value="${Lsolicitud.objsolicitudpedido.fechaRetiro}"></c:out></td>
                                                <td><c:out value="${Lsolicitud.objsolicitudpedido.estadoPedido}"></c:out></td>
                                                <td><c:out value="${Lsolicitud.objproducto.descripcionProducto}"></c:out></td>
                                                <td><c:out value="${Lsolicitud.objsolicitudpedido.observacionesPedido}"></c:out></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
