                    ...
                    <div class="text-center">
                        <div class="col-lg-12">
                            ...
                            <section class="container">
                                <div class="col-lg-4"></div>
                                <form name="frm" method="post" action="./categoriaADDServlet" role="form" class="col-lg-4 pure-form"> 
                                    <div class="form-group">                   
                                        <input type="text" class="form-control"  placeholder="Ingrese Nombre Categoria" name="txtNomrbeCategoriaADD" required/>
                                    </div>                                                                                        
                                    <div class="form-group">
                                        <input class="form-group" id="enviar" value="Agregar" type="submit" />
                                    </div> 
                                </form>
                            </section>
                            <br/><br/>
